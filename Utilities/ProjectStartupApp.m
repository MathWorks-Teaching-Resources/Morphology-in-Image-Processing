classdef ProjectStartupApp < matlab.apps.AppBase
    ...
    properties (Access = private)
        ...
        GitHubRepository = "Morphology-in-Image-Processing";
    end
...
%}
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.WelcomeTitle.Position = [2 334 274 58];
            app.WelcomeTitle.Text = 'Welcome to Binary Morphology';
            ...
            app.Image.Position = [16 141 245 186];
            app.Image.ImageSource = 'bot.png';
            ...
            app.ReviewTitle.Position = [2 326 274 66];
            app.ReviewTitle.Text = 'Welcome to Binary Morphology';
