classdef ProjectStartupApp < matlab.apps.AppBase
    ...
    properties (Access = private)
        ...
        ImagePath {mustBeFile} = fullfile("Images","DilationAnimation.gif"); 
    end
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.StartUpAppUIFigure.Position = [100 100 276 507];
            ...
            app.WelcomePanel.Position = [-551 110 244 410];
            ...
            app.CoverImage.ImageSource = 'DilationAnimation.gif';
            ...
            app.FeedBackPanel.Position = [-291 110 236 409];
